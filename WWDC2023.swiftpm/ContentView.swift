...
struct ContentView: View {
    ...
    func loopByLossFunc(accuracies: Array<Array<Array<Double>>>) {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button {
                loopByLossFunc(accuracies: accuracies1)
                let hiddenLayerIndex = hiddenLayers.firstIndex(of: Int($hiddenLayerSelection.wrappedValue) ?? 0)
                print(hiddenLayerIndex ?? 0)
